...
public class ClienteDaoImpl
  ...
  public void actualizar(ClienteBean bean) {
    ...
    try {
      ...
      throw new RuntimeException("Error en el proceso Actualizar Cliente, intentelo mas tarde.");
    } finally {
      try {
        cn.close();
      } catch (Exception e) {
  ...
  public void eliminar(String codigo) {
    ...
    try {
      ...
      throw new RuntimeException("Error en el proceso Eliminar Cliente, intentelo mas tarde.");
    } finally {
      try {
        cn.close();
      } catch (Exception e) {
